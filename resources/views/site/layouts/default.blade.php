...
<html lang="en-US" class="no-js">
	<head>
        ...
        <!-- META TAGS -->
        <meta name="keywords" content="agricultural, business, chemical, construction, energy, engineering, gas, industrial, industries, manufacturing, material, mechanical, oil, petroleum">
...
<body>
    ...
    <section>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="home-about span-ha">
                    ...
                    <p class="strong">For almost 100 years, Indusy has met the demands of a growing world. The Indusy farmer has a tremendous opportunity</p>

                    <p>A primary focus of Indusy is policy development and implementation. Policy development starts with our farmer/members and culminates at the annual meeting of voting delegates. I s tasked with accomplishing.</p>
                    <figure class="about-signature"><img src="img/images/signature.png" alt=""></figure>
                </div>
              </div>
              <div class="col-lg-6 space-break span-ha">
                <div class="organic-pulsing-video">
                  <div class="youtube-popup" data-listnum="1" style="display: none">
                    <a href="https://www.youtube.com/watch?v=bfdR-pkI_98" class="popup-youtube">
                        <figure class="video-image"><img src="https://via.placeholder.com//992x700" alt=""></figure>
                    </a>
        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-lg-5 parallax-side-alt"></div>
              <div class="col-lg-7 content-side-alt">
                <div class="inner-content-alt">
                  <div class="panel-title">
                    <h5>WHY US</h5>
                    <h2>A bright nature of decision</h2>
                  </div>
                  <p style="margin-bottom: 15px;">Indusy has met the demands of a growing world. The Indusy farmer has a tremendous, policy development and implementation. Policy development </p>
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour. Randomised words which don't look even slightly believable.</p>
                  <hr class="divider-alt">

                  <div class="span-services">
                      <div class="row">
                          <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="sp-counter">
                                <div class="counter-statistics">
                                    <div class="counter">467</div>
                                    <p>Construction</p>
                                </div>
                            </div>
                          </div>
                          <div class="col-sm-4 col-md-4 col-lg-4 sp-counter-center">
                            <div class="sp-counter">
                                <div class="counter-statistics">
                                    <div class="counter">1293</div>
                                    <p>Staff Involved</p>
                                </div>
                            </div>
                          </div>
            ...
            <div class="team-carousel slider hover-effects image-hover">
              <div class="slide">
                 <div class="team-portrait">
                    <figure class="tp-headshot"><img src="https://via.placeholder.com//992x1300" alt=""></figure>
